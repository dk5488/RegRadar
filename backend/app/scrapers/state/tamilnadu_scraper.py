...
class TamilNaduScraper(BaseScraper):
    source_name = "Tamil Nadu State Government"
    ...
    async def fetch(self) -> List[RawDocument]:
        ...
        try:
            ...
            logger.info("TamilNaduScraper fetch complete", doc_count=len(documents))
        except Exception as e:
            logger.error(f"Failed to fetch TamilNaduScraper", error=str(e))
