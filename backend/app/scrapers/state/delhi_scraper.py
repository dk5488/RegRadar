...
class DelhiScraper(BaseScraper):
    source_name = "Delhi NCT Government"
    base_url = "https://labour.delhi.gov.in/"
    ...
    async def fetch(self) -> List[RawDocument]:
        ...
        try:
            ...
            logger.info("DelhiScraper fetch complete", doc_count=len(documents))
        except Exception as e:
            logger.error(f"Failed to fetch DelhiScraper", error=str(e))
